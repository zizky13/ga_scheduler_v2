...
import type { Room, TimeSlot, Lecturer, Course, CourseOffering } from '../types.js';
...
export const courseOfferings: CourseOffering[] = [
  ...
  {
    id: 1, courseId: 1, course: courses[0]!, roomId: 4,
    room: rooms[3]!, lecturers: [lecturers[1]!],
    effectiveStudentCount: 28, isFixed: false,
  },
  // Offering 2: Basis Data — LAB-A, Dewi (prefers Tue/Wed)
  {
    id: 2, courseId: 3, course: courses[2]!, roomId: 4,
    room: rooms[3]!, lecturers: [lecturers[3]!],
    effectiveStudentCount: 25, isFixed: false,
  },
  // Offering 3: Sistem Operasi — LAB-B, Gunawan (prefers Thu/Fri)
  {
    id: 3, courseId: 9, course: courses[8]!, roomId: 5,
    room: rooms[4]!, lecturers: [lecturers[6]!],
    effectiveStudentCount: 28, isFixed: false,
  },
  ...
  {
    id: 4, courseId: 2, course: courses[1]!, roomId: 1,
    room: rooms[0]!, lecturers: [lecturers[2]!],
    effectiveStudentCount: 38, isFixed: false,
  },
  // Offering 5: Jaringan Komputer — R-102, Team teaching: Andi + Budi
  {
    id: 5, courseId: 4, course: courses[3]!, roomId: 2,
  ...
  {
    id: 7, courseId: 6, course: courses[5]!, roomId: 1,
    room: rooms[0]!, lecturers: [lecturers[0]!],
    effectiveStudentCount: 30, isFixed: false,
  },
  // Offering 8: Keamanan Informasi — R-102, Fani (prefers afternoon)
  {
    id: 8, courseId: 10, course: courses[9]!, roomId: 2,
    room: rooms[1]!, lecturers: [lecturers[5]!],
    effectiveStudentCount: 35, isFixed: false,
  },
  ...
  {
    id: 9, courseId: 7, course: courses[6]!, roomId: 6,
    room: rooms[5]!, lecturers: [lecturers[2]!],
    effectiveStudentCount: 22, isFixed: false,
  },

  // ── R-201 flexible (competes with fixed #6 and #15) ────────────
  // Offering 10: TA Seminar — R-201, Dewi, 44 students / 45 cap = 1 session
  {
    id: 10, courseId: 8, course: courses[7]!, roomId: 3,
    room: rooms[2]!, lecturers: [lecturers[3]!],
    effectiveStudentCount: 44, isFixed: false,
  },
  ...
  {
    id: 11, courseId: 2, course: courses[1]!, roomId: 1,
    room: rooms[0]!, lecturers: [lecturers[7]!],
    effectiveStudentCount: 36, isFixed: false,
  },

  // ── More contention on R-201 (3 offerings: 6-fixed, 10, 12) ───
  // Offering 12: RPL (section B) — R-201, Fani (prefers afternoon)
  {
    id: 12, courseId: 5, course: courses[4]!, roomId: 3,
    room: rooms[2]!, lecturers: [lecturers[5]!],
    effectiveStudentCount: 42, isFixed: false,
  },
  ...
  {
    id: 13, courseId: 6, course: courses[5]!, roomId: 5,
    room: rooms[4]!, lecturers: [lecturers[4]!, lecturers[7]!],
    effectiveStudentCount: 28, isFixed: false,
  },
  ...
  {
    id: 14, courseId: 1, course: courses[0]!, roomId: 4,
    room: rooms[3]!, lecturers: [lecturers[6]!],
    effectiveStudentCount: 27, isFixed: false,
  },
...
export const infeasibleFacility: CourseOffering = {
  id: 91, courseId: 1, course: courses[0]!, roomId: 1,
  room: rooms[0]!, lecturers: [lecturers[1]!],
  effectiveStudentCount: 35, isFixed: false,
};

/** Room capacity: 0-capacity room */
export const infeasibleCapacity: CourseOffering = {
  id: 92, courseId: 2, course: courses[1]!, roomId: 1,
...
export const infeasibleNoLecturer: CourseOffering = {
  id: 93, courseId: 3, course: courses[2]!, roomId: 4,
  room: rooms[3]!, lecturers: [],
  effectiveStudentCount: 20, isFixed: false,
};

/** Fixed but no fixedTimeSlotIds */
export const infeasibleFixedNoSlots: CourseOffering = {
  id: 94, courseId: 4, course: courses[3]!, roomId: 2,
  room: rooms[1]!, lecturers: [lecturers[0]!],
  effectiveStudentCount: 30, isFixed: true,
